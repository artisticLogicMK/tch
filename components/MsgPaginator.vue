...
<template>
  <div class="flex items-center justify-between px-3 xs:px-4 py-2">
    ...
    <div class="flex space-x-1.5 xs:space-x-2">
      ...
      <Button variant="outline" :disabled="currentPage >= totalPages" @click="goToPage(currentPage + 1)">Older</Button>
      ...
      <Button variant="outline" :disabled="currentPage <= 1" @click="goToPage(currentPage - 1)">Newer</Button>
